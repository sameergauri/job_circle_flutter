            ...
            children: [
              ...
              Wrap(
                children: [
                  InkWell(
                    onTap: () async {
                      if (widget.item.document_status != "Under Review" &&
                          widget.item.document_status != "Submitted" &&
                          widget.item.document_status != "Not Submitted") {
                        NewChangeStatusModel changeStatusModel =
                    ...
                    child: widget.item.document_status != "Under Review" &&
                            widget.item.document_status != "Submitted"
                        ? Container(
                  ...
                  InkWell(
                      onTap: () async {
                        if (widget.item.document_status != "Submitted" &&
                            widget.item.document_status != "Under Review") {
                          NewChangeStatusModel changeStatusModel =
                              NewChangeStatusModel(
                                  /* status: "IB7",
                      ...
                      child: widget.item.document_status != "Submitted"
                          ? Container(
                              margin: EdgeInsets.only(right: 6.w),
                              decoration: BoxDecoration(
                                  color: widget.item.document_status ==
...
//TODO:: Documenrt Status}
          ...
          if (widget.item.status_id == 18 && widget.item.company_workstatus == 1
                    ...
                    : InkWell(
                        ...
                        child: Container(
                          padding: EdgeInsets.symmetric(
                              vertical: 2.h, horizontal: 4.w),
                          child: Text("Edit",
                              style: GoogleFonts.varela(color: Constants.blue)),
                        ),
                      )
              ],
            ),
                    ...
                    decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            color: widget.item.doj != null
                                ? widget.item.doj?.day == tomorrow.day &&
                                        widget.item.doj!.month ==
                                            tomorrow.month &&
                                        widget.item.doj!.year == tomorrow.year
                                    ? Colors.blue
                                    : widget.item.doj!.day ==
                                                DateTime.now().day &&
                                            widget.item.doj!.month ==
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        widget.item.doj != null
                            ? widget.item.doj!.day == DateTime.now().day &&
                                    widget.item.doj!.month ==
                                        DateTime.now().month &&
                                    widget.item.doj!.year == DateTime.now().year
                                ? Text("Today",
                                    style: GoogleFonts.varela(
                                        color: Colors.green,
                  ...
                  ? Wrap(
                      children: List.generate(
                        ...
                        (index) => GestureDetector(
                            onTap: widget.finalDropDownItemforJoinNot[index]
                                        .priStatusId ==
                                    18
                                ? () {
                                    showDialog(
                        ...
                        GestureDetector(
                          onTap: () async {
...

                            {
                              NewChangeStatusModel changeStatusModel =
                                  NewChangeStatusModel(
                                      doj: widget.item.doj, notes: notes.text);
                              Map<String, dynamic> jsonData =
                                  changeStatusModel.toJson();
                              try {
                                await JobPostApiService.NewchangeStatus(
                          ...
                          child: Container(
                            ...
                            child: Text("Submit",
                                style:
                                    GoogleFonts.varela(color: Constants.blue)),
                          ),
                        ),
                      ],
                    )
