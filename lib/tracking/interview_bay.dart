// ignore_for_file: unused_result, avoid_unnecessary_containers, avoid_print, use_build_context_synchronously, use_full_hex_values_for_flutter_colors
              ...
              Wrap(
                children: List.generate(
                  ...
                  (index) => GestureDetector(
                    onTap: widget.finalDropDownItem[index].sec_status_remark ==
                            1
                        ? () async {
                            showDialog(
                              context: context,
                        ...
                        : () async {
                            NewChangeStatusModel changeStatusModel =
                              ...
                              hrStatusId: 0,
                              statusId:
                                  widget.finalDropDownItem[index].secStatusId,
                            );
                            Map<String, dynamic> jsonData =
                                changeStatusModel.toJson();
                            try {
                ...
                children: List.generate(
                  ...
                  (index) => GestureDetector(
                    onTap: widget.finalDropDownItem[index].priStatusId !=
                            13 //TODO : Select
                        ? widget.finalDropDownItem[index].pri_status_remark == 1
                            ? () async {
                                await showDialog(
                                  context: context,
                                  builder: (context) {
