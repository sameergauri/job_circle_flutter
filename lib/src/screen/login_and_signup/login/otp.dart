...
class _OTPScreenState extends State<OTPScreen> with CodeAutoFill {
  ...
  @override
  void codeUpdated() {
    // ✅ This is called when OTP SMS is detected
    if (code != null && code!.length >= 4) {
      final provider = Provider.of<LoginProvider>(context, listen: false);

      setState(() {
        provider.otp1.text = code![0];
        provider.otp2.text = code![1];
        provider.otp3.text = code![2];
        provider.otp4.text = code![3];
      });
