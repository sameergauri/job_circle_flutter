...
class CvParseEditSkills extends StatelessWidget {
  const CvParseEditSkills({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        titleSpacing: 0.0,
        title: OnboardingTitle(title: "Skills"),
                          ...
                          child: ListTile(
                            ...
                            onTap: () {
                              if (provider.tempSelectedSkills.contains(
                                ...
                                provider.toggleSkill(suggestion);
                                provider.skillController.clear();
                                provider.fetchSkills();
                              }
                            },
