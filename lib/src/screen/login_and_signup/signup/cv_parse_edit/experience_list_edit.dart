...
class ExperienceListEdit extends StatelessWidget {
  final FromEditOrAdd fromEditOrAdd;
  const ExperienceListEdit({super.key, required this.fromEditOrAdd});
      ...
      builder: (context, provider, child) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: const OnboardingTitle(title: "Experience"),
            actions: [
              !provider.showExperienceForm &&
                  ...
                  : (provider.experiencesModel.isNotEmpty &&
                        FromEditOrAdd.edit == fromEditOrAdd)
                  ? IconButton(
                      onPressed: () {
          ...
          body: SafeArea(
            child:
                provider.experiencesModel.isEmpty || provider.showExperienceForm
                ...
                Row(
                  children: [
                    ...
                    if (exp.lastWorkingDate != null &&
                        exp.lastWorkingDate.toString().toLowerCase() !=
                            'present' &&
                        exp.lastWorkingDate.toString().toLowerCase() !=
                            'current')
                      customText(
            ...
            if (provider.isEditingExperience &&
              ...
              Row(
                ...
                children: [
                  TextButton(
                    onPressed: () {
                      provider.removeExperience(provider.experienceEditIndex!);
                      provider.clearExperienceForm();
              ...
              child: CustomButtonForSave(
                ...
                onTap: () {
                  if (provider.jobtitle.text.isEmpty) {
                    ...
                    CustomSnackbar.show("Add skill to save experience", true);
