...
class CustomTechnicalSkill extends StatelessWidget {
  final ProfileProvider provider;

  const CustomTechnicalSkill({super.key, required this.provider});
          ...
          provider.profile!.technicalSkills!.isEmpty
              ? Padding(
                  ...
                  child: const customText(
                    title:
                        "Add Technical Skills that best define your expertise.",
                    fontSize: 14,
