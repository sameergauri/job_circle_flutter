...
final profileSummaryProvider = FutureProvider<ProfileModel>((ref) async {
  final summaryResponse = await _NewJobsWithTabViewState.bindProfileSummary();
...
final JobsProvider = FutureProvider<List<JobsModel>>((ref) async {
  final jobResponse = await _NewJobsWithTabViewState.bindAllJobs();
  if (jobResponse != null) {
...
/* final jobsProvider = FutureProvider<List<JobsModel>>((ref) async {
  final jobsRes = await _NewJobsWithTabViewState.bindJobs();
  if (jobsRes != null) {
...
final jobsDataProvider = FutureProvider<JobsDataModel>((ref) async {
  final job = await _NewJobsWithTabViewState.bindJobs();
  final jobsData = (job).map((item) => JobsModel.fromJson(item)).toList();
  final profile = await _NewJobsWithTabViewState.bindProfileSummary();
  final profileData =
...
class NewJobsWithTabView extends ConsumerStatefulWidget {
  const NewJobsWithTabView({super.key});

  @override
  ConsumerState<NewJobsWithTabView> createState() => _NewJobsWithTabViewState();
}

class _NewJobsWithTabViewState extends ConsumerState<NewJobsWithTabView>
                  ...
                  child: TabBar(
                    ...
                    tabs: [
                      ...
                      if (data.profile.usertype != 1)
                        Tab(
                          child: customTab(
                              "My Jobs", "assets/images/check.png", 1),
                        ),
                      if (data.profile.usertype == 1)
                        Tab(
                          child: customTab(
                      ...
                      if (data.profile.usertype == 1)
                        Tab(
                          child: customTab(
                              "Fresher", "assets/images/check.png", 2),
                        ),
                    ],
                  ), */
                            ...
                            final selected = await showModalBottomSheet<String>(
                              ...
                              builder: (BuildContext context) {
                                return LocationSelector(
                                  locationList: locationList = data.jobs
                                      .map((job) =>
                                          job.city ??
                            ...
                            child: InkWell(
                              onTap: () async {
                                FilterDialog filterDialog = FilterDialog(
                                    /* filteredData,
                                  data.jobs, */
                                    onFilterApplied: (List<JobsModel>
                                        updatedfilteredJobsData) {},
                                    storedSelectedOptions:
                                        storedSelectedOptions,
                                    storedSelectedCategory:
                                        storedSelectedCategory,
                    ...
                    Expanded(
                        child: TabBarView(
                                  ...
                                  children: [
                                    Expanded(
                                                                            ...
                                                                            children: [
                                                                                    ...
                                                                                    child: Column(
                                                                                      ...
                                                                                      children: [
                                                                                        Text(
                                                                                          ...
                                                                                          style: GoogleFonts.varela(fontWeight: FontWeight.bold, fontSize: 16.sp),
                                                                                        ),
                                                                                        Row(
                                                                                    ...
                                                                                    if (item.minCTC != null)
                                                                                      Row(
                                                                                        ...
                                                                                        children: [
                                                                                          ...
                                                                                          Text(
                                                                                            formatSalaryRange(item.minCTC!.toInt(), item.maxCTC!.toInt()),
                                                                                            style: GoogleFonts.varela(
                                                                                              fontSize: 13.sp,
                                                                                              color: Constants.subtitleclr,
                                                                                            ),
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    if (updatedList.length > 5)
                                                                                      Container(
                                                                                        ...
                                                                                        child: Text(
                                                                                          '+${updatedList.length - 5}'.replaceAll('"', '').replaceAll('[', '').replaceAll(']', ''),
                                                                                          style: GoogleFonts.varela(
                                                                                            color: Colors.black,
                                                                                            fontWeight: FontWeight.bold,
                                                                                            fontSize: 13.sp,
                                                                              ...
                                                                              Row(
                                                                                children: [
                                                                                  Column(
                                                                                    children: [
                                                                                      profileModel.usertype == 3 && profileModel.id == item.spoc
                                                                                          ? InkWell(
                                                                                              onTap: () {
                                                                                  ...
                                                                                  const Spacer(),
                                                                                  Visibility(
                                                                                    visible: data.profile.usertype == 3,
                                                                                    child: InkWell(
                                                                                      onTap: () {
                                                                                        Navigator.push(
                                                                                            context,
                                                                                  ...
                                                                                  Visibility(
                                                                                    visible: data.profile.usertype == 1,
                                                                                    child: InkWell(
                                                                                      onTap: () {
                                                                                        var profilemodel;
                                                                                        Navigator.push(
                                                                                      ...
                                                                                      child: Container(
                                                                                        ...
                                                                                        decoration: BoxDecoration(border: Border.all(color: Constants.themeBgColor), borderRadius: BorderRadius.circular(8)),
                                                                                        child: Text(
                                                                                          "Refer Now",
                                                                                          style: GoogleFonts.varela(color: Constants.themeBgColor, fontWeight: FontWeight.bold),
                                                                                        ),
                                                                                      ),
                                                                                    ),
                                                                                  ),
                                                                                  Visibility(
                                                                                    ...
                                                                                    child: InkWell(
                                                                                      onTap: () {
                                                                                        JobPostApiService.postJobApply(jobId: item.id!.toInt(), userId: int.parse(data.profile.id.toString()), context: context);
                                                                                      },
                                                                                      child: Container(
                                                                                        margin: const EdgeInsets.only(
                                                                                          left: 10,
                                                                                ...
                                                                                children: [
                                                                                  Center(
                                                                                    child: Padding(
                                                                                      ...
                                                                                      child: RichText(
                                                                                        text: TextSpan(
                                                                                          style: GoogleFonts.varela(color: Colors.black, fontSize: 20, fontWeight: FontWeight.bold),
                                      ...
                                      languageKnown: jobDetailsModel.languageknown, */
                                                                        ...
                                                                        : Positioned(
                                                                            ...
                                                                            child: IconButton(
                                                                                onPressed: () async {
                                                                                  if ((item.isFav ?? 0) == 1) {
                                                                                    await removeFromFav(item.favJobId!.toInt());
                                                                                    combinedData = ref.refresh(userJobDataProvider);
                                                                                  } else {
                                                                                    await addToFav(item.id ?? 0, data.profile.id!.toInt());
                                      ...
                                      item[index]["id"].toString() */
                                                                                    (item.isFav) == 1 && (item.userId == data.profile.id) ? Icons.bookmark : Icons.bookmark_add_outlined,
                                                                                    size: 22.h,
                                                                                    color: Constants.themeBgColor)),
                                                                          )
                                                                  ],
                          ...
                          ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return ListTile(
                                title: Text(data.jobs[index].spoc.toString()),
                              );
                            },
                          ),
                        ]))
