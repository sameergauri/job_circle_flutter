...
/* final profileProvider = FutureProvider<ProfileModel>((ref) async { //TODO: for future builder refresh
  final profileRes = await _NewJobsState.bindProfileSummary();
  if (profileRes != null) {
    return (profileRes)
...
class _NewJobsState extends ConsumerState<NewJobs>
  ...
  bindProfileSummary() async {
    ...
    if (Utils.parseResponse(result).resultKey == 'SUCCESS') {
      ...
      profileModel = ProfileModel.fromJson(dataResult);
    }
    setState(() {});
  }
  ...
  void _applyLocationFilter(String selectedLocation) {
    setState(() {
      filteredJobsData = allJobs
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
              ...
              children: [
                UserAccountsDrawerHeader(
                  ...
                  accountName: Column(
                    ...
                    children: [
                      Text(
                        "${profileModel.firstName.toString()} ${profileModel.lastName.toString()}",
                        style: GoogleFonts.varela(
                            fontSize: 16.sp,
                            color: Constants.themeBgColor,
                            fontWeight: FontWeight.bold),
                      ),
                      Text(profileModel.userLocation.toString(),
                          style: GoogleFonts.varela(
                  ...
                  currentAccountPicture: InkWell(
                      ...
                      child: profileModel.profilePic == null
                          ? CircleAvatar(
                              backgroundColor:
                          ...
                          : CircleAvatar(
                              ...
                              onBackgroundImageError: ((error, stackTrace) =>
                                  Image.network(
                                      "https://s3.ap-south-1.amazonaws.com/job-circle-2/${profileModel.profilePic}",
                                      height: 80,
                                      width: 80,
                                      fit: BoxFit.contain)),
        ...
        floatingActionButton: profileModel.usertype == 3
            ? Visibility(
            ...
            child: TabBar(
              ...
              onTap: (value) {
                setState(() {
                  cutTab = value;
                  isSelect = !isSelect;
                  if (value == 1 && profileModel.usertype == 1) {
                    isSelect ? _applyFavFilter() : refreshData();
                  }
                  ...
                  if (value == 2 && profileModel.usertype == 1) {
                    isSelect ? _applyFreshFilter() : refreshData();
                  }
                });
              },
              ...
              tabs: [
                ...
                if (profileModel.usertype != 1)
                  Tab(
                    child: customTab("My Jobs", "assets/images/check.png", 1),
                  ),
                if (profileModel.usertype == 1)
                  Tab(
                    child: customTab("Save Jobs", "assets/images/check.png", 1),
                  ),
                if (profileModel.usertype == 1)
                  Tab(
                              ...
                              onLocationSelected: (selectedLocation) {
                                if (selectedLocation.isNotEmpty) {
                                  setState(() {
                                    ...
                                    _applyLocationFilter(selectedLocation);
                                  });
                                }
                              },
                            );
                                    ...
                                    itemBuilder: (BuildContext, index) {
                                      ...
                                      if (item.skills != null) {
                                        if (item.skills is String) {
                                          ...
                                          myStrings = (item.skills as String)
                                              .split(",");
                                                            ...
                                                            IconButton(
                                                              onPressed:
                                                                ...
                                                                if ((item.isFav ??
                                                                  ...
                                                                  await addToFav(
                                                                      item.id ??
                                                                          0); // Replace with the correct variable or expression
                                                                }
