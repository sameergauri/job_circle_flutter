...
class CertificateList extends StatefulWidget {
  ...
  late List<CertificationDetailModel>? certificateList;
   final int userid;
    ...
    return Padding(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            final data = widget.certificateList?[index];
            return Column(
              children: [
                ListTile(
                  onTap: () {},
                  ...
                  leading: SizedBox(
                      width: 70.w,
                      height: 70.h,
                      child: data!.certLogo != null
                          ? Image.network(
                              "${GlobalConstants.Image_url}${data.certLogo.toString()}",
                              fit: BoxFit.contain,
                  ...
                  subtitle: customTextForMonst(
                    title:
                        "${data.startMonth.toString()} - ${data.startYear.toString()}",
                    fontSize: 12,
                    fontWeight: FontWeight.w500,
                    overflow: TextOverflow.ellipsis,
                            ...
                            MaterialPageRoute(
                                builder: (context) => CertificateEdit(
                                  ...
                                  userid: widget.userid,
                                    certlength: widget.certificateList!.length,
                                    prevPageModel: data,
                                    isEdit: true,
                                    isFirst: false)));
                      },
