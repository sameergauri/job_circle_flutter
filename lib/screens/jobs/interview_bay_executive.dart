...
final fetchAllExecutiveProvide = FutureProvider<List<Applicant>>((
  ref,
) {
  return _InterViewBayExecutiveState.fetchAllApplicants();
});
//enum Issue { no, incorrect, recruiter, other }

class InterViewBayExecutive extends ConsumerStatefulWidget {
  const InterViewBayExecutive({
    super.key,
  });

  @override
  ConsumerState<InterViewBayExecutive> createState() =>
      _InterViewBayExecutiveState();
}
...
List<String?> getStatuses(List<Applicant> applicants) {
  return applicants
      /* .where((element) => element.status_id != 3)
      .where((element) => element.status_id != 4) */
...
class _InterViewBayExecutiveState extends ConsumerState<InterViewBayExecutive>
...
//TODO: old salry formater code which is not working properly.
  ...
  Widget build(BuildContext context) {
    ...
    var fetchApplicants =
        profilemodel.id != null ? ref.watch(fetchAllExecutiveProvide) : null;
...
//TODO:: old code of executive PipeLine..... before 02/03/2024

/* // ignore_for_file: unused_import, override_on_non_overriding_member, unused_field, unused_result, unused_local_variable, unnecessary_null_comparison, avoid_print, non_constant_identifier_names, no_leading_underscores_for_local_identifiers
// ignore_for_file: todo
import 'dart:convert';
